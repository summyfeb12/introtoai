...
/**
 * An implementation of {@link org.alicebot.server.core.Interpreter} that
 * handles server-side JavaScript using the Rhino package.
 * 
 * @author Jon Baer
 * @version 1.0
 */
public class RhinoInterpreter implements Interpreter {
    ...
    public String evaluate(final String expression) {
        ...
        try {
            ...
            Log.userinfo("JavaScript exception (see interpreter log).",
                    Log.ERROR);
