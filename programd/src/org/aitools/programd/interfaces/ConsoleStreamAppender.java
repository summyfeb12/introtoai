...
public class ConsoleStreamAppender extends WriterAppender {
     ...
     * @param shellToWatch
     */
    public void watch(final Shell shellToWatch) {
     ...
     * exceptions (for uncaught exceptions, see
     * {@link org.aitools.programd.CoreSettings}).
     * 
     * @param value
     *            whether or not to print stack traces for &quot;caught&quot;
     *            exceptions
     */
    public void setPrintStackTraces(final boolean value) {
        ...
        if (this.printStackTraces) {
            ...
            if (ti != null) {
                ...
                if (t != null) {
                    ...
                    if (message != null) {
                        this.qw.write(event.getThrowableInformation()
    ...
    public synchronized void setWriter(final OutputStream stream) {
